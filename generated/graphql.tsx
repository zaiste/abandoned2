...
export type AbandonedCartsQueryVariables = Exact<{ [key: string]: never; }>;
...
export const AbandonedCartsDocument = gql`
...
/**
 * __useAbandonedCartsQuery__
 *
 * To run a query within a React component, call `useAbandonedCartsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAbandonedCartsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAbandonedCartsQuery({
 *   variables: {
 *   },
 * });
 */
export function useAbandonedCartsQuery(baseOptions?: Apollo.QueryHookOptions<AbandonedCartsQuery, AbandonedCartsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AbandonedCartsQuery, AbandonedCartsQueryVariables>(AbandonedCartsDocument, options);
      }
export function useAbandonedCartsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AbandonedCartsQuery, AbandonedCartsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AbandonedCartsQuery, AbandonedCartsQueryVariables>(AbandonedCartsDocument, options);
        }
export type AbandonedCartsQueryHookResult = ReturnType<typeof useAbandonedCartsQuery>;
export type AbandonedCartsLazyQueryHookResult = ReturnType<typeof useAbandonedCartsLazyQuery>;
export type AbandonedCartsQueryResult = Apollo.QueryResult<AbandonedCartsQuery, AbandonedCartsQueryVariables>;